<x-layout>
    ...
    <h1 class="text-2xl font-bold mb-6">This is a product creator</h1>
    ...
    <form id="uploadForm" action="/products/test" method="POST" enctype="multipart/form-data">
        ...
        <section class="h-full p-8 w-full flex flex-col">
            ...
            <ul id="gallery-before" class="flex flex-1 flex-wrap -m-1 mt-2">
                <li id="empty-before" class="h-full w-full text-center flex flex-col justify-center items-center">
        ...
        <section class="h-full p-8 w-full flex flex-col">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-4 flex text-sm leading-6 text-gray-600">
                        <label id="button" for="file-upload"
                            ...
                            <input id="imageUpload" type="file" name="files[]" multiple accept="image/*" class="hidden">
                        </label>
            ...
            <ul id="gallery-after" class="flex flex-1 flex-wrap m-1">
                <li id="empty-after" class="h-full w-full text-center flex flex-col justify-center items-center">
                    <img class="mx-auto w-32"
                        src="https://user-images.githubusercontent.com/507615/54591670-ac0a0180-4a65-11e9-846c-e55ffce0fe7b.png"
                        alt="no data" />
        ...
        <button type="submit" id="submitBtn" class="rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Submit</button>
    ...
    <template id="image-template-before">
        <li class="block p-1 w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/8 h-24">
            <article tabindex="0"
                ...
                <input type="checkbox" class="image-checkbox" value="enabled" hidden checked>
                <section class="flex flex-col rounded-md text-xs break-words w-full h-full z-20 absolute top-0 py-2 px-3">
                    ...
                    <div class="flex">
                        ...
                        <a class="delete-btn-before delete ml-auto focus:outline-none bg-red-500 hover:bg-gray-300 p-1 rounded-md">
            ...
            <article tabindex="0"
                ...
                <section class="flex flex-col rounded-md text-xs break-words w-full h-full z-20 absolute top-0 py-2 px-3">
                    ...
                    <div class="flex">
                        ...
                        <p class="p-1 size text-xs"></p>
                        <a class="delete-btn-after delete ml-auto focus:outline-none p-1 rounded-md bg-red-500" onmouseover="hoverEffect(true)" onmouseout="hoverEffect(false)">
                            <svg class="pointer-events-none fill-current w-4 h-4 ml-auto" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" viewBox="0 0 24 24">
                                <path class="pointer-events-none"
                                    d="M3 6l3 18h12l3-18h-18zm19-4v2h-20v-2h5.711c.9 0 1.631-1.099 1.631-2h5.316c0 .901.73 2 1.631 2h5.711z" />
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            fetchImages(`products/34/images`);
    ...
    try {
        ...
        console.error('Błąd podczas pobierania zdjęć:', error);
            ...
            function addImageToGallery(file, id, existing, targetGallery) {
                const objectURL = URL.createObjectURL(file); //tu jest
